...
def localLossL1(fake_s, real_s, real_p, criterionL1):
    ...
    sh0, s0 = dot_product(fake_s, real_s, real_p[:,1,:,:])
    sh1, s1 = dot_product(fake_s, real_s, real_p[:,2,:,:])
    sh2, s2 = dot_product(fake_s, real_s, real_p[:,3,:,:])
    sh3, s3 = dot_product(fake_s, real_s, real_p[:,4,:,:])
    sh4, s4 = dot_product(fake_s, real_s, real_p[:,5,:,:])
    sh5, s5 = dot_product(fake_s, real_s, real_p[:,6,:,:])
    sh6, s6 = dot_product(fake_s, real_s, real_p[:,7,:,:])
    sh7, s7 = dot_product(fake_s, real_s, real_p[:,8,:,:])
