...
def init():
    ...
    parser.add_argument('--root', type=str, default='.', help='image source folder')
    ...
    # parser.add_argument('--infofile', default=['./data/list_train_small.txt', './data/list_test_small.txt'], help='infofile')
    parser.add_argument('--infofile', default=['./data/list_train_cufs.txt', './data/list_test_cufs.txt'], help='infofile')
    # parser.add_argument('--infofile', default=['./data/list_train_cufsf.txt', './data/list_test_cufsf.txt'], help='infofile')
    ...
    parser.add_argument('--model_vgg', type=str, default='../Models/vgg.model', help='vgg model')
